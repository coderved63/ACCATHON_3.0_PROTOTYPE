    ...
    return (
        <div className="space-y-6 text-white pb-20">
                    ...
                    <div className="bg-[#0a0a0a] p-8 rounded-xl border border-white/5">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white/5 p-5 rounded-xl border border-white/5 mt-6 group">
                                <p className="text-[10px] text-slate-500 font-bold uppercase mb-3">Formula</p>
                                <p className="text-xs text-indigo-400 font-mono leading-relaxed">
                                    TV_PV = [FCFF₅ × (1 + g) / (WACC - g)] / (1 + WACC)⁵
                                </p>
                            </div>

                            <div className="flex justify-between items-center py-4 border-t border-white/5 mt-6">
                                <span className="text-slate-300 text-xs font-bold uppercase tracking-wider">Terminal Value (PV)</span>
                                <span className="text-slate-300 font-bold font-mono">{dcf.pv_of_terminal_value ? `₹${dcf.pv_of_terminal_value.toLocaleString()}` : "₹1,24,500.32"}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-[#0a0a0a] p-8 rounded-xl border border-white/5">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 py-10 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <FlowNode label="+ PV Terminal Val" value={dcf.pv_of_terminal_value ? `₹${dcf.pv_of_terminal_value.toLocaleString()}` : "₹1,24,500.32"} />
                    <ArrowRight className="text-indigo-900 hidden md:block" size={16} />
