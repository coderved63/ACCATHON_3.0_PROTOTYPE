                ...
                <>
                    ...
                    <div className="flex gap-4 mb-8">
                        <SignalCard
                            ...
                            colorClass="bg-emerald-950/20 border-emerald-900/50 text-emerald-500"
                        />
                        <SignalCard
                            type="HOLD"
                            ...
                            colorClass="bg-amber-950/20 border-amber-900/50 text-amber-500"
                        />
                        <SignalCard
                            type="SELL"
                            ...
                            colorClass="bg-red-950/20 border-red-900/50 text-red-500"
                        />
                    </div>
